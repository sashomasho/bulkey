...
using namespace bulgariankeyboard;
...
static jint bulgariankeyboard_BinaryDictionary_open
...
static int bulgariankeyboard_BinaryDictionary_getSuggestions(
...
static int bulgariankeyboard_BinaryDictionary_getBigrams
...
static jboolean bulgariankeyboard_BinaryDictionary_isValidWord
...
static void bulgariankeyboard_BinaryDictionary_close
...
static JNINativeMethod gMethods[] = {
    {"openNative",           "(Ljava/nio/ByteBuffer;II)I",
                                          (void*)bulgariankeyboard_BinaryDictionary_open},
    {"closeNative",          "(I)V",            (void*)bulgariankeyboard_BinaryDictionary_close},
    {"getSuggestionsNative", "(I[II[C[IIIII[II)I",  (void*)bulgariankeyboard_BinaryDictionary_getSuggestions},
    {"isValidWordNative",    "(I[CI)Z",         (void*)bulgariankeyboard_BinaryDictionary_isValidWord},
    {"getBigramsNative",    "(I[CI[II[C[IIII)I",         (void*)bulgariankeyboard_BinaryDictionary_getBigrams}
};
    ...
    JNINativeMethod* gMethods, int numMethods)
{
    ...
    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "aaaaaaaa");
    clazz = env->FindClass(className);
    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "bbbbbbbb");
    if (clazz == NULL) {
        fprintf(stderr,
            "Native registration unable to find class '%s'\n", className);
        return JNI_FALSE;
    }
    ///__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "cccccccc");
    if (env->RegisterNatives(clazz, gMethods, numMethods) < 0) {
        fprintf(stderr, "RegisterNatives failed for '%s'\n", className);
        return JNI_FALSE;
    }

    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "dddddddd");
    return JNI_TRUE;
}

static int registerNatives(JNIEnv *env)
{
    const char* const kClassPathName = "org/apelikecoder/bulgariankeyboard2/BinaryDictionary";
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "00000000");
    if (vm->GetEnv((void**) &env, JNI_VERSION_1_6) != JNI_OK) {
        fprintf(stderr, "ERROR: GetEnv failed\n");
        goto bail;
    }
    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "11111111");
    assert(env != NULL);

    //__android_log_print(ANDROID_LOG_INFO, LOG_TAG, "22222222");
    if (!registerNatives(env)) {
        fprintf(stderr, "ERROR: BinaryDictionary native registration failed\n");
        goto bail;
    }
    __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "LOAD NATIVE LIBRARY");
